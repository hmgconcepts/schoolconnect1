...
const CHATBOT_KB = [
  ...
  { match: ['feature','module','what'], reply: 'You get **88 modules** covering academics, finance, communication, media, and enterprise. The full list with explanations is in **FEATURES.md**. Pick the modules you want in Step 5 of the wizard.' },
