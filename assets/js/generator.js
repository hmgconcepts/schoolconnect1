...
const Generator = {
  ...
  async build(config) {
    ...
    /* Per-module pages */
    const registryIds = (window.SC.MODULES || []).map(m => m.id);
    const pageIds = [...new Set([
      ...registryIds,
      'report-cards','admin-data','cbt-prompts','entrance','storage','academic_setup','academic_records','developer','digital_library',
